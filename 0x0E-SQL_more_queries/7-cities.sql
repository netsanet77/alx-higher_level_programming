...
-- cities.state_id INT, can’t be null and must be a FOREIGN KEY that references to id of the states table
-- cities.name VARCHAR(256) can’t be null
-- if hbtn_0d_usa and/or cities already exists, your script should not fail
